...
export const HeroSectionBackground = ({ children, showArrow = false }: { children: React.ReactNode, showArrow?: boolean }) => {
    return (
        <section className="relative min-h-screen overflow-hidden !flex flex-1 items-center justify-center">
            <img src="/Vinteg_3.jpg" alt="Hero Background" className="absolute inset-0 w-full h-full object-cover" />
            {/* Background with gradient overlay */}
            <div className="absolute opacity-50 inset-0 bg-gradient-to-br from-primary-900 via-secondary-500 to-primary-900">
